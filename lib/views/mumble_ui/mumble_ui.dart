...
import 'package:push_to_talk_app/utils/gui_utils.dart';
import 'package:push_to_talk_app/views/mumble_ui/mumble_ui_view_model.dart';
                          ...
                          TextButton(
                            onPressed: () {
                              mumbleUiVM
                                  .disconnect()
                                  .then(
                                    (value) => GuiUtils().showTextSnackbar(
                                      context,
                                      'Disconnected!',
                                    ),
                                  )
